    ...
    return (
        <div className="container mt-5">
            ...
            <div className="input-section input-group d-flex flex-wrap">
                <input type="text" placeholder="Todo Name" value={taskName} className='form-control me-3 rounded' onChange={(e) => setTaskName(e.target.value)}/>
                <input type="text" placeholder="Todo description" value={taskDescription} className='form-control me-3 rounded' onChange={(e) => setTaskDescription(e.target.value)}/>
            ...
            <div className="filter-section">
                ...
                <span className='mt-2'>Status Filter : </span>
                    ...
                    <div className="todo-item mb-4 col-md-4 col-sm-12" key={index}>
                        {editIndex === index ? (
                            <div className='card h-100 '>
                                <input type="text" value={editTaskName} className='form-control rounded'  onChange={(e) => setEditTaskName(e.target.value)}/>
                                <input type="text" value={editTaskDescription} className='form-control rounded' onChange={(e) => setEditTaskDescription(e.target.value)}/>
                                <select value={editTaskStatus} className='select-control rounded' onChange={(e) => setEditTaskStatus(e.target.value)}>
                                    <option value="completed">Completed</option>
                                    <option value="pending">Pending</option>
                                </select>
